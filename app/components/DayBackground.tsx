...
export default function DayBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden" style={{ backgroundColor: '#f5f5f0' }}>
      <style>{`
      ...
      <div
        className={`absolute -left-80 -top-60 w-[2000px] h-[2000px] rounded-full opacity-60 bg-blob blob-1 ${reduced ? '' : 'animate-rotate-fast'}`}
        style={{
      ...
      <div
        className={`absolute -right-80 -bottom-60 w-[1800px] h-[1800px] rounded-full opacity-55 bg-blob blob-2 ${reduced ? '' : 'animate-rotate-fast-reverse'}`}
        style={{
          mixBlendMode: 'multiply',
      ...
      <div
        className={`absolute left-1/2 top-1/4 -translate-x-1/2 w-[1400px] h-[1400px] rounded-full opacity-55 bg-blob blob-3 ${reduced ? '' : 'animate-rotate-fast'}`}
        style={{
          mixBlendMode: 'multiply',
      ...
      <div
        className={`absolute -right-60 top-1/3 w-[1200px] h-[1200px] rounded-full opacity-55 bg-blob blob-4 ${reduced ? '' : 'animate-rotate-fast-reverse'}`}
        style={{
          mixBlendMode: 'multiply',
      ...
      <div
        className={`absolute -left-60 bottom-0 w-[1300px] h-[1300px] rounded-full opacity-50 bg-blob blob-5 ${reduced ? '' : 'animate-rotate-fast'}`}
        style={{
          mixBlendMode: 'multiply',
