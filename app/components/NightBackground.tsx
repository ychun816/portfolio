...
export default function NightBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden" style={{ backgroundColor: '#08080b' }}>
      ...
      {/* Gradient blobs — luxurious sapphire and indigo palette */}
      <div
        className={`absolute -left-80 -top-60 w-[2000px] h-[2000px] rounded-full opacity-55 bg-blob blob-1 ${reduced ? '' : 'animate-rotate-fast'}`}
        style={{
          mixBlendMode: 'screen',
          background: 'radial-gradient(closest-corner at 30% 30%, rgba(100,180,240,0.85), rgba(110,185,250,0.65) 20%, rgba(120,190,255,0.45) 35%, rgba(130,195,260,0.15) 60%, transparent 85%)'
        }}
      />
      ...
      <div
        ...
        style={{
          mixBlendMode: 'screen',
          background: 'radial-gradient(closest-corner at 28% 25%, rgba(75,160,220,0.82), rgba(85,170,235,0.65) 15%, rgba(95,180,250,0.45) 30%, rgba(105,190,265,0.15) 55%, transparent 82%)'
        }}
      />
      ...
      <div
        ...
        style={{
          mixBlendMode: 'screen',
          background: 'radial-gradient(closest-corner at 45% 45%, rgba(110,185,245,0.80), rgba(120,190,255,0.55) 20%, rgba(130,200,265,0.35) 40%, rgba(140,210,270,0.12) 65%, transparent 85%)'
        }}
      />

      {/* Blob 4 - right side, lower position - deep indigo sapphire */}
      <div
        ...
        style={{
          mixBlendMode: 'screen',
          background: 'radial-gradient(closest-corner at 32% 35%, rgba(95,175,235,0.78), rgba(105,185,248,0.58) 18%, rgba(115,195,255,0.38) 35%, rgba(125,205,265,0.15) 60%, transparent 82%)'
        }}
      />

      {/* Blob 5 - left side, bottom area - rich sapphire */}
      <div
        className={`absolute -left-60 bottom-0 w-[1300px] h-[1300px] rounded-full opacity-45 bg-blob blob-5 ${reduced ? '' : 'animate-rotate-fast'}`}
        style={{
          mixBlendMode: 'screen',
          background: 'radial-gradient(closest-corner at 36% 40%, rgba(100,180,240,0.75), rgba(110,190,255,0.52) 20%, rgba(120,200,265,0.32) 40%, rgba(130,210,270,0.12) 65%, transparent 85%)'
        }}
      />
