...
const socialLinks: SocialLink[] = [
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/sophia-lin-profile/',
    icon: (
  ...
  {
    name: 'Email',
    url: 'mailto:sophia.lin168@protonmail.com',
    icon: (
      <svg className="w-7 h-7 md:w-9 md:h-9" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-7 h-7 md:w-9 md:h-9" fill="currentColor" viewBox="0 0 24 24">
        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-8-6zm-3 16H8v-2h3v2zm3-4H8v-2h6v2zm0-4H8V8h6v2z" />
      </svg>
    ),
  },
];
